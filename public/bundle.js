...
var _boardComponent = __webpack_require__(17);
...
var m=__webpack_require__(4),n=__webpack_require__(7),p=__webpack_require__(1),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
var _piece = __webpack_require__(18);
...
var BoardComponent = function (_Component) {
  ...
  function BoardComponent(props) {
    ...
    _this.clickedPositions = _this.clickedPositions.bind(_this);
    return _this;
  }

  _createClass(BoardComponent, [{
    key: 'clickedPositions',
    value: function clickedPositions(x, y) {
      this.setState({
        x: x,
        y: y
      });
    ...
    key: 'renderPieces',
    value: function renderPieces(i) {
      var _this2 = this;

      var x = i % 12;
      var y = Math.floor(i / 12);
      var black = (x + y) % 2 === 1;
      var arr = [this.state.x, this.state.y];
      var PeiceX = arr[0],
          PeiceY = arr[1];

      var peice = x === PeiceX && y === PeiceY ? _react2.default.createElement(_piece2.default, null) : null;
      if (i < 12) {
        return _react2.default.createElement(
          'div',
          {
            ...
            onClick: function onClick() {
              return _this2.clickedPositions(x, y);
            },
            style: {} },
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: {} },
        rows.length < 12 ? _react2.default.createElement(
          'div',
          {
            style: {} },
          rows
...
var Peice = function (_Component) {
  _inherits(Peice, _Component);

  function Peice() {
    _classCallCheck(this, Peice);

    return _possibleConstructorReturn(this, (Peice.__proto__ || Object.getPrototypeOf(Peice)).apply(this, arguments));
  }
  ...
  _createClass(Peice, [{
    ...
    value: function render() {
      return _react2.default.createElement("div", {
        style: { width: 50, height: 50, backgroundColor: "skyblue", borderRadius: "50%" }
      });
    }
  }]);
...
var Row = function (_Component) {
  ...
  _createClass(Row, [{
    ...
    value: function render() {
      ...
      var fill = black ? "white" : "black";
      var stroke = black ? 'black' : 'white';
      return _react2.default.createElement(
        'div',
